...
key2 = "8D7A7068B28DCC8E"
key3 = "ABCDEFGH12345678"
init_vector = "A1B2C3D4E5F6G7H8"
aes_send = AES.new(key3.encode(), AES.MODE_ECB)
aes_k1 = AES.new(key1.encode(), AES.MODE_ECB)
aes_k2 = AES.new(key2.encode(), AES.MODE_ECB)
connections_vector = []
...
try:
    ...
    def main(client, number_of_threads):
        ...
        while True:
            ...
            if send_data == "ECB":
                encrypted_key1 = aes_send.encrypt(key1.encode())
                client.send(b'0')
                ...
                encrypted_key2 = aes_send.encrypt(key2.encode())
